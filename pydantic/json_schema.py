...
class GenerateJsonSchema:
    ...
    def generate_inner(self, schema: CoreSchemaOrField) -> JsonSchemaValue:
        ...
        current_handler = _schema_generation_shared.GenerateJsonSchemaHandler(self, self.handler_func)
        ...
        for js_modify_function in metadata_handler.metadata.get('pydantic_js_functions', ()):
            current_handler = _schema_generation_shared.GenerateJsonSchemaHandler(
                self, self.get_modified_handler_func(current_handler, js_modify_function)
            )

        for js_modify_function in metadata_handler.metadata.get('pydantic_js_annotation_functions', ()):
            current_handler = _schema_generation_shared.GenerateJsonSchemaHandler(
                self, self.get_modified_handler_func(current_handler, js_modify_function, True)
            )
    ...
    def populate_defs(self, core_schema: CoreSchema, json_schema: JsonSchemaValue) -> JsonSchemaValue:
    ...
    def convert_to_all_of(self, json_schema: JsonSchemaValue) -> JsonSchemaValue:
    ...
    def handler_func(self, schema_or_field: CoreSchemaOrField) -> JsonSchemaValue:
    ...
    def get_modified_handler_func(
        self, current_handler: GetJsonSchemaHandler, js_modify_function: GetJsonSchemaFunction, convert_all_of=False
    ) -> GetJsonSchemaHandler:
        def new_handler_func(schema_or_field: CoreSchemaOrField) -> JsonSchemaValue:
